  ...
  if (viewMode === 'annual') {
    ...
    return (
      <div className="space-y-5">
        ...
        <SurfaceCard className="overflow-hidden p-5">
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <DeltaChip
                label="ahorro"
                value={annualData.savingsRate}
                kind="percent"
                icon={<CircleDollarSign size={16} />}
                forcePositive={annualData.netAmount >= 0}
              />
            </div>
          </div>
        </SurfaceCard>
        ...
        <CategoryListCard
          title="categorías que más pesan"
          subtitle="gasto anual"
          categories={annualData.expenseCategories}
          maxAmount={maxExpenseAmount}
          tone="expense"
          emptyText="Todavía no hay gasto suficiente para analizar categorías."
        />

        <CategoryListCard
          title="ingresos por categoría"
          subtitle="origen anual"
          categories={annualData.incomeCategories}
          maxAmount={maxIncomeAmount}
          tone="income"
          emptyText="Todavía no hay ingreso suficiente para analizar categorías."
        />
        ...
        >
          ...
          <div className="mt-4 space-y-2">
            ...
            <div className="flex justify-end">
              <span className={`text-[1.05rem] font-medium tabular-nums ${amountClass}`}>
