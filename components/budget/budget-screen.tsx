...
export function BudgetScreen({ data }: { data: DashboardData }) {
  return (
    <div className="space-y-5">
      <PageHeader title="Presupuesto" description="Comparación directa entre lo previsto y lo real, sin ruido visual ni tablas de hoja de cálculo." />
        ...
        <div className="mt-5 space-y-4">
          {data.budgetInsights.length > 0 ? (
            ...
            <div className="rounded-[24px] border border-dashed border-white/10 p-4 text-sm text-white/44">
              Todavía no hay presupuesto cargado para este mes.
            </div>
          )}
        </div>
      </SurfaceCard>
